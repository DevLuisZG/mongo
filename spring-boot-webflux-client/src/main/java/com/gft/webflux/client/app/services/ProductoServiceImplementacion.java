package com.gft.webflux.client.app.services;
...
import com.gft.webflux.client.app.models.Producto;
...
public class ProductoServiceImplementacion implements ProductoService{
	...
	public Flux<Producto> findAll() {
		//aceptando un tipo determinado, enviamos el request, recibimos 
